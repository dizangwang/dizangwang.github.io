...
var mui = (function(a, b) {
    ...
    (i.extend = function() {
        var a,
            ...
            l = !1;
        for (
            "boolean" == typeof h && ((l = h), (h = arguments[j] || {}), j++),
            ...
            if (null != (a = arguments[j]))
                for (c in a)
                    ...
                    (e = a[c]),
                    h !== e &&
                    (l && e && (i.isPlainObject(e) || (f = i.isArray(e))) ?
                        (f ?
                            ((f = !1), (g = d && i.isArray(d) ? d : [])) :
                            (g = d && i.isPlainObject(d) ? d : {}),
                            (h[c] = i.extend(l, g, e))) :
                        e !== b && (h[c] = e));
        return h;
    }),
    ...
    (i.isPlainObject = function(a) {
        return (
            i.isObject(a) && !i.isWindow(a) && Object.getPrototypeOf(a) === Object.prototype
        );
    }),
    ...
    (i.qsa = function(b, c) {
        return (
            ...
            i.slice.call(
                e.test(b) ?
                c.getElementsByClassName(RegExp.$1) :
                f.test(b) ?
    ...
    (i.buffer = function(a, b, c) {
        ...
        return i.extend(
            function() {
                !f || (g >= f && i.now() - g > b) || (g < f && i.now() - f > 8 * b) ?
                    d.apply(this, arguments) :
                    (e && e.cancel(), (e = i.later(d, b, null, i.slice.call(arguments))));
            }, {
                stop: function() {
                    e && (e.cancel(), (e = 0));
                },
    ...
    (i.trigger = function(a, b, c) {
        return (
            a.dispatchEvent(new CustomEvent(b, { detail: c, bubbles: !0, cancelable: !0 })),
            this
        );
    }),
    ...
    (i.parseTranslate = function(a, b) {
        ...
        return (
            (c && c[1]) || (c = ["", "0,0,0"]),
            (c = c[1].split(",")),
            (c = { x: parseFloat(c[0]), y: parseFloat(c[1]), z: parseFloat(c[2]) }),
    ...
    (i.parseTranslateMatrix = function(a, b) {
        ...
        c
            ?
            ((c = c[2].split(",")),
                "3d" === d ? (c = c.slice(12, 15)) : (c.push(0), (c = c.slice(4, 7)))) :
            (c = [0, 0, 0]);
        ...
        var d = [
            ...
            function() {
                ...
                return (
                    ...
                    ((this.os.android = !0),
                        (this.os.version = a[2]),
                        (this.os.isBadAndroid = !/Chrome\/\d/.test(b.navigator.appVersion))), !0 === this.os.android
                );
            },
            function() {
...
(function(a) {
    ...
    var b = 1,
        ...
        g = function(b, c) {
            return (
                b.detail ? (b.detail.currentTarget = c) : (b.detail = { currentTarget: c }),
                a.each(
                    d,
                    function(a, c) {
                        var d = b[a];
        ...
        j = function(b, d, e, f) {
            return function(e) {
                for (
                    var f = c[b._mid][d], h = [], i = e.target, j = {}; i &&
                    i !== document &&
                    i !== b &&
                    (!~["click", "tap", "doubletap", "longtap", "hold"].indexOf(d) ||
                        (!i.disabled && !i.classList.contains("mui-disabled"))); i = i.parentNode
                ) {
                    var k = {};
                    a.each(
                            f,
                        ...
                        a.isEmptyObject(k) || h.push({ element: i, handlers: k });
                }
                (j = null),
                (e = g(e)),
                a.each(
...
(function(a, b, c) {
    ...
    b.addEventListener(a.EVENT_START, function(b) {
            for (var d = b.target, e = {}; d && d !== c; d = d.parentNode) {
                var f = !1;
                if (
                    (a.each(a.targetHandles, function(c, g) {
                            var h = g.name;
                            f || e[h] || !g.hasOwnProperty("handle") ?
                                e[h] || (!1 !== g.isReset && (a.targets[h] = !1)) :
                                ((a.targets[h] = g.handle(b, d)),
                                    a.targets[h] && ((e[h] = !0), !0 !== g.isContinue && (f = !0)));
                        }),
                        f)
                )
                    break;
        ...
        b.addEventListener("click", function(b) {
            for (
                var d = b.target, e = !1; d &&
                d !== c &&
                ("A" !== d.tagName ||
                    (a.each(a.targetHandles, function(a, c) {
                        c.name;
                        if (c.hasOwnProperty("handle") && c.handle(b, d))
                            return (e = !0), b.preventDefault(), !1;
                    }), !e)); d = d.parentNode
            );
        });
})(mui, window, document),
...
(function(a) {
    "classList" in a.documentElement ||
    ...
    if ((a.os.android || a.os.ios) && !b.FastClick) {
        var d = function(a, b) {
            return (
                "LABEL" === b.tagName &&
                b.parentNode &&
                (b = b.parentNode.querySelector("input")), !(!b || ("radio" !== b.type && "checkbox" !== b.type) || b.disabled) && b
            );
        };
        ...
        b.addEventListener("tap", e),
            ...
            b.addEventListener(
                "click",
                function(b) {
                    if (a.targets.click && !b.forwardedTouchEvent)
                        return (
                            b.stopImmediatePropagation ?
                            b.stopImmediatePropagation() :
                            (b.propagationStopped = !0),
                            b.stopPropagation(),
                            b.preventDefault(), !1
                        );
                }, !0
            ...
            b.addEventListener("focusin", function(d) {
                    if (!(
                        ...
                        if (
                            ...
                            ("TEXTAREA" === e.tagName ||
                                ("INPUT" === e.tagName &&
                                    ("text" === e.type || "search" === e.type || "number" === e.type)))
                        ) {
                            ...
                            for (var f = !1; e && e !== b; e = e.parentNode) {
                                var g = e.classList;
                                if (
                                    (g && g.contains("mui-bar-tab")) ||
                                    g.contains("mui-bar-footer") ||
                                    g.contains("mui-bar-footer-secondary") ||
                                    g.contains("mui-bar-footer-secondary-tab")
                                ) {
                                    f = !0;
                                    break;
                                }
...
(function(a, b) {
    ...
    var c = Math.round,
        ...
        m = function(b, c) {
            a.gestures.stoped ||
                a.doAction("gestures", function(d, e) {
                    a.gestures.stoped ||
                        (!1 !== a.options.gestureConfig[e.name] && e.handle(b, c));
                });
        },
        n = function(a, b) {
            for (; a;) {
        ...
        s = function(b) {
            var c = a.gestures.session,
                ...
                f = c.prevDelta || {},
                g = c.prevTouch || {};
            (b.gesture.type !== a.EVENT_START && b.gesture.type !== a.EVENT_END) ||
            ((f = c.prevDelta = { x: g.deltaX || 0, y: g.deltaY || 0 }),
                (e = c.offsetDelta = { x: d.x, y: d.y })),
        ...
        t = function(b) {
            ...
            c.firstTouch || (c.firstTouch = r(b)),
                q() && e > 1 && !c.firstMultiTouch ?
                (c.firstMultiTouch = r(b)) :
                1 === e && (c.firstMultiTouch = !1);
            var f = c.firstTouch,
                l = c.firstMultiTouch,
        ...
        y = function(b, c) {
            ...
            return (
                ...
                k - l == 0 &&
                ((c.isFirst = !0),
                    (a.gestures.touch = a.gestures.session = { target: b.target })),
    ...
    b.addEventListener(a.EVENT_START, z),
        b.addEventListener(a.EVENT_MOVE, z, !!A && { passive: !1, capture: !1 }),
        b.addEventListener(a.EVENT_END, z),
        b.addEventListener(a.EVENT_CANCEL, z),
        b.addEventListener(
            a.EVENT_CLICK,
            function(b) {
                (a.os.android || a.os.ios) &&
                ((a.targets.popover && b.target === a.targets.popover) ||
                    a.targets.tab ||
                    a.targets.offcanvas ||
                    a.targets.modal) &&
                b.preventDefault();
...
(function(a, b) {
    var c = function(c, d) {
        ...
        if (c.type === a.EVENT_END || c.type === a.EVENT_CANCEL) {
            ...
            (d.swipe = !1),
            d.direction &&
                f.swipeMaxTime > d.deltaTime &&
                d.distance > f.swipeMinDistince &&
                ((d.swipe = !0),
        ...
        switch (c.type) {
            ...
            case a.EVENT_MOVE:
                ...
                e.lockDirection &&
                    e.startDirection &&
                    e.startDirection &&
                    e.startDirection !== d.direction &&
                    ("up" === e.startDirection || "down" === e.startDirection ?
                        (d.direction = d.deltaY < 0 ? "up" : "down") :
                        (d.direction = d.deltaX < 0 ? "left" : "right")),
            ...
            switch (e.type) {
                case a.EVENT_END:
                    ...
                    if (f.distance < h.tapMaxDistance && f.deltaTime < h.tapMaxTime) {
                        if (
                            a.options.gestureConfig.doubletap &&
                            c &&
                            c === i &&
                            d &&
                            f.timestamp - d < h.tapMaxInterval
                        )
            ...
            case a.EVENT_MOVE:
                if (a.options.gestureConfig.pinch) {
                    ...
                    var g = d.scale,
                        ...
                        j = 1e-12;
                    g > i ?
                        ((i = g - j), a.trigger(f.target, b + "out", d)) :
                        g < i && ((i = g + j), a.trigger(f.target, b + "in", d)),
                        Math.abs(h) > e.minRotationAngle && a.trigger(f.target, "rotate", d);
                }
                break;
            case a.EVENT_END:
            case a.EVENT_CANCEL:
                a.options.gestureConfig.pinch &&
                    f.pinch &&
                    2 === d.touches.length &&
                    ((f.pinch = !1), a.trigger(f.target, b + "end", d));
        }
    };
...
(function(a) {
    ...
    a(function() {
        var b = document.body.classList,
            c = [];
        a.os.ios ?
            (c.push({ os: "ios", version: a.os.version }), b.add("mui-ios")) :
            a.os.android &&
            (c.push({ os: "android", version: a.os.version }), b.add("mui-android")),
            a.os.wechat &&
            (c.push({ os: "wechat", version: a.os.wechat.version }), b.add("mui-wechat")),
            c.length &&
            a.each(c, function(c, d) {
                var e = "";
                d.version &&
                    a.each(d.version.split("."), function(c, f) {
...
(function(a) {
            ...
            if (b) {
                if (void 0 === d) d = "";
                    ...
                    if ("boolean" == typeof d || "number" == typeof d)
                        return void b.evalJS(
                            "typeof mui!=='undefined'&&mui.receive('" + c + "'," + d + ")"
                        );
                    (a.isPlainObject(d) || a.isArray(d)) &&
                    (d = JSON.stringify(d || {})
                        .replace(/\'/g, "\\u0027")
                        .replace(/\\/g, "\\u005c"));
                }
    ...
    (a.openWindow = function(b, f, g) {
        if (
            ("object" == typeof b ?
                ((g = b), (b = g.url), (f = g.id || b)) :
                "object" == typeof f ?
                ((g = f), (f = g.id || b)) :
                (f = f || b), !a.os.plus)
        )
            return void(a.os.ios || a.os.android ?
        ...
        if (window.plus) {
            ...
            if (
                (a.webviews[f] ?
                    ((l = a.webviews[f]), plus.webview.getWebviewById(f) && (k = l.webview)) :
                    !0 !== g.createNew && (k = plus.webview.getWebviewById(f)),
                    k)
            )
                return (
                    (h = l ? l.show : c),
                    ...
                    l &&
                    l.afterShowMethodName &&
                    k.evalJS(l.afterShowMethodName + "('" + JSON.stringify(j) + "')"),
                    k
                );
            if (!b) throw new Error("webview[" + f + "] does not exist");
            var m = a.waitingOptions(g.waiting);
            if (
                (m.autoShow && (i = plus.nativeUI.showWaiting(m.title, m.options)),
                    (g = a.extend(g, { id: f, url: b })),
                    (k = a.createWindow(g)),
                ...
                var n = function() {
                    i && i.close(),
                        ...
                        g.afterShowMethodName &&
                        k.evalJS(g.afterShowMethodName + "('" + JSON.stringify(j) + "')");
                };
    ...
    (a.openWindowWithTitle = function(b, f) {
        ...
        if (!a.os.plus)
            return void(a.os.ios || a.os.android ?
                (window.top.location.href = g) :
                (window.parent.location.href = g));
        if (window.plus) {
            var i,
                j,
                k = b.params || {},
            ...
            if (
                (a.webviews[h] ?
                    ((m = a.webviews[h]), plus.webview.getWebviewById(h) && (l = m.webview)) :
                    !0 !== b.createNew && (l = plus.webview.getWebviewById(h)),
                    l)
            )
                return (
                    (i = m ? m.show : c),
                    ...
                    m &&
                    m.afterShowMethodName &&
                    l.evalJS(m.afterShowMethodName + "('" + JSON.stringify(k) + "')"),
                    l
                );
            if (!g) throw new Error("webview[" + h + "] does not exist");
            var n = a.waitingOptions(b.waiting);
            if (
                (n.autoShow && (j = plus.nativeUI.showWaiting(n.title, n.options)),
                    (b = a.extend(b, { id: h, url: g })),
                    (l = a.createWindow(b)),
                    f)
            ) {
                ...
                if (
                    (p.drawRect(a.options.titleConfig.bottomBorderColor, {
                            top: q + "px",
                            left: "0px",
                        }),
                    ...
                    p.addEventListener(
                        ...
                        function(b) {
                            ...
                            t &&
                                c > t.left &&
                                c < t.right &&
                                (s.click && a.isFunction(s.click) ?
                                    s.click() :
                                    l.evalJS("window.mui&&mui.back();"));
                        }, !1
                    ),
                    l.append(p);
            }
            return (
                (i = a.showOptions(b.show)),
                i.autoShow &&
                l.addEventListener(
                    i.event,
                    function() {
    ...
    (a.createWindow = function(b, c) {
        if (window.plus) {
            var d,
                e = b.id || b.url;
            if (b.preload) {
                a.webviews[e] && a.webviews[e].webview.getURL() ?
                    (d = a.webviews[e].webview) :
                    (!0 !== b.createNew && (d = plus.webview.getWebviewById(e)),
                        d ||
                        ((d = plus.webview.create(
                                b.url,
                                e,
                                a.windowOptions(b.styles),
                                a.extend({ preload: !0 }, b.extras)
                            )),
                            b.subpages &&
                            a.each(b.subpages, function(b, c) {
                                var e = c.id || c.url;
                                if (e) {
                                    var f = plus.webview.getWebviewById(e);
                                    f ||
                                        (f = plus.webview.create(
                                            c.url,
                                            e,
                                            a.windowOptions(c.styles),
                                            a.extend({ preload: !0 }, c.extras)
                                        )),
                                        d.append(f);
                                }
                            }))),
                ...
                !1 !== c &&
                ((d = plus.webview.create(b.url, e, a.windowOptions(b.styles), b.extras)),
                    b.subpages &&
                    a.each(b.subpages, function(b, c) {
                        var e = c.id || c.url,
        ...
        if (c)
            for (var d = 0, e = c.length; d < e; d++) {
                var f = c[d],
                    g = f.opened();
                g && g.length > 0 ?
                    (a.closeOpened(f), f.close("none")) :
                    f.parent() !== b && f.close("none");
            }
    }),
        ...
        if (window.plus) {
            ...
            return (
                ...
                (plus.webview.getWebviewById(d) ||
                    (c = plus.webview.create(b.url, d, b.styles, b.extras)),
                ...
                a.os.plus &&
                    a.plusReady(function() {
                        a.each(c, function(b, c) {
                            ...
                            a.os.ios &&
                            a.options.statusBarBackground &&
                            plus.navigator.setStatusBarBackground(a.options.statusBarBackground),
                            a.os.android &&
                            parseFloat(a.os.version) < 4.4 &&
...
(function(a, b) {
    ...
    a.addBack({
        ...
        (a.back = function() {
            ("function" == typeof a.options.beforeback && !1 === a.options.beforeback()) ||
            a.doAction("backs");
        }),
        b.addEventListener("tap", function(b) {
            var c = a.targets.action;
            c &&
                c.classList.contains("mui-action-back") &&
                (a.back(), (a.targets.action = !1));
        }),
...
(function(a, b) {
        ...
        a.addBack({
            ...
            handle: function() {
                ...
                return (
                    ...
                    c.canBack(function(d) {
                        d.canBack ?
                            b.history.back() :
                            c.id === plus.runtime.appid ?
                            a.__back__first ?
                            new Date().getTime() - a.__back__first < 2e3 &&
                            plus.runtime.quit() :
                            ((a.__back__first = new Date().getTime()),
                                mui.toast("再按一次退出应用"),
                                setTimeout(function() {
                                    a.__back__first = null;
                                }, 2e3)) :
    ...
    a.plusReady(function() {
            a.options.keyEventBind.backbutton && plus.key.addEventListener("backbutton", c, !1),
                a.options.keyEventBind.menubutton &&
        ...
        a.addInit({
            ...
            handle: function() {
                a.plusReady(function() {
                    a.options.keyEventBind.backbutton ||
                        plus.key.removeEventListener("backbutton", c),
                        a.options.keyEventBind.menubutton ||
...
(function(a, b, c) {
    ...
    var j = function(a, b) {
        ...
        r = function(b, d, e, f) {
            return (
                a.isFunction(d) && ((f = e), (e = d), (d = c)),
                a.isFunction(e) || ((f = e), (e = c)), { url: b, data: d, success: e, dataType: f }
            );
        };
    (a.ajax = function(d, e) {
        ...
        o(f);
        var h = f.dataType;
        (!1 !== f.cache && ((e && !0 === e.cache) || "script" !== h)) ||
        (f.url = p(f.url, "_=" + a.now()));
        ...
        "file:" === location.protocol &&
            a.os.ios &&
            b.webkit &&
            b.webkit.messageHandlers &&
            !(t instanceof plus.net.XMLHttpRequest) &&
            console.error(
                "当前运行环境为WKWebview，需在plusReady事件触发后再调用mui.ajax，否则可能会执行失败或报Script error的错误"
            );
        var u,
            v = t.setRequestHeader;
        if (
            (r("X-Requested-With", "XMLHttpRequest"),
                r("Accept", m || "*/*"),
                (m = f.mimeType || m) &&
                (m.indexOf(",") > -1 && (m = m.split(",", 2)[0]),
                    t.overrideMimeType && t.overrideMimeType(m)),
                (f.contentType ||
                    (!1 !== f.contentType && f.data && "GET" !== f.type.toUpperCase())) &&
                r("Content-Type", f.contentType || "application/x-www-form-urlencoded"),
                f.headers)
        )
            for (var w in f.headers) r(w, f.headers[w]);
        if (
            ((t.setRequestHeader = r),
                (t.onreadystatechange = function() {
                    if (4 === t.readyState) {
                        ...
                        if (
                            ...
                            304 === t.status ||
                            (0 === t.status && d && t.responseText)
                        ) {
                            (h = h || q(f.mimeType || t.getResponseHeader("content-type"))),
                            (b = t.responseText);
                            try {
                                "script" === h
                                    ?
                                    ...
                                    "xml" === h ?
                                    (b = t.responseXML) :
                                    "json" === h && (b = i.test(b) ? null : a.parseJSON(b));
                            } catch (a) {
                                c = a;
                            }
            ...
            return t.abort(), l(null, "abort", t, f), t;
        if (f.xhrFields)
                ...
                if ("file:" !== b.protocol) {
                    ...
                    if (
                        ((d.href = c.url),
                            (d.href = d.href),
                            (c.crossDomain =
                                b.protocol + "//" + b.host != d.protocol + "//" + d.host),
                            c.crossDomain)
                    )
                        return new plus.net.XMLHttpRequest();
                }
                return a.os.ios && window.webkit && window.webkit.messageHandlers ?
...
(function(a) {
    ...
    (d.extend = function(a) {
        ...
        for (var g in a)
            f[g] =
            "function" == typeof a[g] && "function" == typeof e[g] && c.test(a[g]) ?
            (function(a, b) {
                return function() {
                    var c = this._super;
                    this._super = e[a];
            ...
            a[g];
        return (
            (d.prototype = f), (d.prototype.constructor = d), (d.extend = arguments.callee), d
        );
    }),
    (a.Class = d);
})(mui),
(function(a, b, c) {
    var d = "mui-pull-top-pocket",
        ...
        u = [
            '<div class="' + f + '">',
            '<div class="{icon}"></div>',
            '<div class="' + h + '">{contentrefresh}</div>',
            "</div>",
        ].join(""),
        v = {
            init: function(b, c) {
            ...
            _initPocket: function() {
                var a = this.options;
                a.down &&
                    a.down.hasOwnProperty("callback") &&
                    ((this.topPocket = this.scroller.querySelector("." + d)),
                        this.topPocket ||
                        ((this.topPocket = this._createPocket(d, a.down, s)),
                            this.wrapper.insertBefore(this.topPocket, this.wrapper.firstChild)),
                        (this.topLoading = this.topPocket.querySelector("." + g)),
                        (this.topCaption = this.topPocket.querySelector("." + h))),
                    a.up &&
                    a.up.hasOwnProperty("callback") &&
                    ((this.bottomPocket = this.scroller.querySelector("." + e)),
                        this.bottomPocket ||
                        ((this.bottomPocket = this._createPocket(e, a.up, t)),
            ...
            _createPocket: function(a, c, d) {
                ...
                return (
                    (e.className = a),
                    (e.innerHTML = u
                        .replace("{contentrefresh}", c.contentinit)
                        .replace("{icon}", d)),
                    e
                );
            },
                        ...
                        (b ?
                            setTimeout(function() {
                                ...
                                g
                                    ?
                                    (f.className = s) :
                                    (h._setCaptionClass(!1, e, a), (f.className = t)),
                            ...
                            ((e.innerHTML = a),
                                g ?
                                a === c.down.contentrefresh ?
                                ((f.className = t),
                                    (f.style.webkitAnimation = "spinner-spin 1s step-end infinite")) :
                                a === c.down.contentover ?
                                ((f.className = r),
                                    (f.style.webkitTransition = "-webkit-transform 0.3s ease-in"),
                                    (f.style.webkitTransform = "rotate(180deg)")) :
                                a === c.down.contentdown &&
                                ((f.className = s),
                                    (f.style.webkitTransition = "-webkit-transform 0.3s ease-in"),
                                    (f.style.webkitTransform = "rotate(0deg)")) :
                                (a === c.up.contentrefresh ?
                                    (f.className = t + " " + q) :
                                    (f.className = t + " " + p),
...
(function(a, b, c, d) {
    var e = "mui-scroll",
        ...
        l = a.Class.extend({
            init: function(b, c) {
                ...
                this._init(),
                    this.scroller &&
                    (this.refresh(), this.scrollTo(this.options.startX, this.options.startY));
            },
            _init: function() {
            ...
            _initParallax: function() {
                this.options.parallaxElement &&
                    ((this.parallaxElement = c.querySelector(this.options.parallaxElement)),
            ...
            _initIndicators: function() {
                ...
                if (((a.indicators = []), this.options.indicators)) {
                    var b,
                        c = [];
                    a.options.scrollY &&
                        ((b = { el: this._createScrollBar(h), listenX: !1 }),
                            this.wrapper.appendChild(b.el),
                            c.push(b)),
                        this.options.scrollX &&
                        ((b = { el: this._createScrollBar(i), listenY: !1 }),
                            this.wrapper.appendChild(b.el),
                            c.push(b));
            ...
            _initSnap: function() {
                ...
                for (
                    ...
                    var k = a[i],
                        l = k.offsetLeft,
                        m = k.offsetWidth;
                    (0 === i || l <= a[i - 1].offsetLeft) && ((c = 0), d++),
                    this.pages[c] || (this.pages[c] = []),
                        (e = this._getSnapX(l)),
                        (h = Math.round(m * this.options.snapX)),
                        (f = e - h),
                        (g = e - m + h),
                        (this.pages[c][d] = { x: e, leftX: f, rightX: g, pageX: c, element: k }),
            ...
            _gotoPage: function(a) {
                ...
                for (var b = 0, c = this.snaps.length; b < c; b++)
            ...
            _nearestSnap: function(a) {
                ...
                var b = 0,
                    c = this.pages.length;
                for (
                    a > 0 ? (a = 0) : a < this.maxScrollX && (a = this.maxScrollX); b < c; b++
                ) {
                    if (
                        a >=
                        ("left" === this.direction ?
                            this.pages[b][0].leftX :
                            this.pages[b][0].rightX)
                    )
            ...
            _drag: function(c) {
                var d = c.detail;
                if (
                    (this.options.scrollY || "up" === d.direction || "down" === d.direction) &&
                    a.os.ios &&
                    parseFloat(a.os.version) >= 8
                ) {
                    var e = d.gesture.touches[0].clientY;
                    if (e + 10 > b.innerHeight || e < 10)
                        return void this.resetPosition(this.options.bounceTime);
                }
                var f = (isReturn = !1);
                this._getDirectionByAngle(d.angle);
                if (
                    ("left" === d.direction || "right" === d.direction ?
                        this.options.scrollX ?
                        ((f = !0),
                            this.moved ||
                            ((a.gestures.session.lockDirection = !0),
                                (a.gestures.session.startDirection = d.direction))) :
                        ...
                        (isReturn = !0),
                        (this.moved || f) &&
                        (c.stopPropagation(), d.gesture && d.gesture.preventDefault()), !isReturn)
                ) {
                    this.moved ?
                        c.stopPropagation() :
                        a.trigger(this.scroller, "scrollstart", this);
                    var g = 0,
                        h = 0;
                    this.moved ?
                        ((g = d.deltaX - a.gestures.session.prevTouch.deltaX),
                            (h = d.deltaY - a.gestures.session.prevTouch.deltaY)) :
                        ((g = d.deltaX), (h = d.deltaY));
                    var i = Math.abs(d.deltaX),
                        j = Math.abs(d.deltaY);
                    i > j + this.options.directionLockThreshold ?
                        (h = 0) :
                        j >= i + this.options.directionLockThreshold && (g = 0),
                        (g = this.hasHorizontalScroll ? g : 0),
                        (h = this.hasVerticalScroll ? h : 0);
                    var k = this.x + g,
                        l = this.y + h;
                    (k > 0 || k < this.maxScrollX) &&
                    (k = this.options.bounce ? this.x + g / 3 : k > 0 ? 0 : this.maxScrollX),
                    (l > 0 || l < this.maxScrollY) &&
                    (l = this.options.bounce ? this.y + h / 3 : l > 0 ? 0 : this.maxScrollY),
                ...
                if (this.moved) {
                    ...
                    if ((this._clearRequestAnimationFrame(), "dragend" !== b.type || !c.flick)) {
                        var d = Math.round(this.x),
                            e = Math.round(this.y);
                        if (
                            ((this.isInTransition = !1), !this.resetPosition(this.options.bounceTime))
                        ) {
                            ...
                            if (
                                ...
                                return (
                                    (d > 0 || d < this.maxScrollX || e > 0 || e < this.maxScrollY) &&
                                    (g = k.quadratic),
                                    void this.scrollTo(d, e, f, g)
                                );
                            a.trigger(this.scroller, "scrollend", this);
                        }
                    }
            ...
            _end: function(b) {
                (this.needReset = !1),
                ((!this.moved && this.needReset) || b.type === a.EVENT_CANCEL) &&
                this.resetPosition();
            },
            _transitionEnd: function(b) {
                b.target == this.scroller &&
                    this.isInTransition &&
                    (this._transitionTime(),
            ...
            _scrollend: function(b) {
                ...
                a.trigger(this.scroller, "scrollbottom", this);
            },
            _resize: function() {
                var a = this;
            ...
            _transitionTime: function(b) {
                if (
                    ((b = b || 0),
                        ...
                        this.options.scrollY &&
                        (this.parallaxStyle.webkitTransitionDuration = b + "ms"),
            ...
            _transitionTimingFunction: function(a) {
                if (
                    ((this.scrollerStyle.webkitTransitionTimingFunction = a),
                        this.parallaxElement &&
                        this.options.scrollY &&
                        (this.parallaxStyle.webkitTransitionDuration = a),
                        this.indicators)
                )
            ...
            _createScrollBar: function(a) {
                ...
                return (
                    ...
                    b.appendChild(d),
                    a === h ?
                    ((this.scrollbarY = b), (this.scrollbarIndicatorY = d)) :
                    a === i && ((this.scrollbarX = b), (this.scrollbarIndicatorX = d)),
            ...
            _momentum: function(a, b, c, e, f, g) {
                ...
                return (
                    ...
                    ((h = f ? e - (f / 2.5) * (j / 8) : e),
                        ...
                        (i = b / j)) :
                    h > 0 &&
                    ((h = f ? (f / 2.5) * (j / 8) : 0), (b = Math.abs(a) + h), (i = b / j)), { destination: Math.round(h), duration: i }
                );
            },
            _getTranslateStr: function(a, b) {
                return this.options.hardwareAccelerated ?
                    "translate3d(" + a + "px," + b + "px,0px) " + this.translateZ :
                    "translate(" + a + "px," + b + "px) ";
            },
            setStopped: function(a) {
                a
                    ?
                    (this.disablePullupToRefresh(), this.disablePulldownToRefresh()) :
                    (this.enablePullupToRefresh(), this.enablePulldownToRefresh());
            },
                ...
                if (
                    ...
                    e > 1 ?
                        ((this.parallaxImgStyle.opacity =
                                1 - (d / 100) * this.options.parallaxRatio),
                            (this.parallaxStyle.webkitTransform =
                                this._getTranslateStr(0, -d) + " scale(" + e + "," + e + ")")) :
            ...
            resetPosition: function(a) {
                var b = this.x,
                    c = this.y;
                return (
                    (a = a || 0), !this.hasHorizontalScroll || this.x > 0 ?
                    (b = 0) :
                    this.x < this.maxScrollX && (b = this.maxScrollX), !this.hasVerticalScroll || this.y > 0 ?
                    (c = 0) :
                    this.y < this.maxScrollY && (c = this.maxScrollY),
                    (b != this.x || c != this.y) &&
                    (this.scrollTo(b, c, a, this.options.scrollEasing), !0)
                );
            },
            _reInit: function() {
                for (
                    var a = this.wrapper.querySelectorAll("." + e), b = 0, c = a.length; b < c; b++
                )
        ...
        m = function(b, d) {
            ...
            (this.scroller = b),
            (this.options = a.extend({ listenX: !0, listenY: !0, fade: !1, speedRatioX: 0, speedRatioY: 0 },
                d
            )),
            (this.sizeRatioX = 1),
            (this.sizeRatioY = 1),
            ...
            this.options.fade &&
                ((this.wrapperStyle.webkitTransform = this.scroller.translateZ),
                    (this.wrapperStyle.webkitTransitionDuration =
                        this.options.fixedBadAndorid && a.os.isBadAndroid ? "0.001s" : "0ms"),
    ...
    (m.prototype = {
        ...
        updatePosition: function() {
            ...
            a < this.minBoundaryX ?
                ((this.width = Math.max(this.indicatorWidth + a, 8)),
                    (this.indicatorStyle.width = this.width + "px"),
                    (a = this.minBoundaryX)) :
                a > this.maxBoundaryX ?
                ((this.width = Math.max(this.indicatorWidth - (a - this.maxPosX), 8)),
                    (this.indicatorStyle.width = this.width + "px"),
                ...
                ((this.width = this.indicatorWidth),
                    (this.indicatorStyle.width = this.width + "px")),
                b < this.minBoundaryY ?
                ((this.height = Math.max(this.indicatorHeight + 3 * b, 8)),
                    (this.indicatorStyle.height = this.height + "px"),
                    (b = this.minBoundaryY)) :
                b > this.maxBoundaryY ?
                ((this.height = Math.max(this.indicatorHeight - 3 * (b - this.maxPosY), 8)),
                    (this.indicatorStyle.height = this.height + "px"),
        ...
        return (
            this.each(function() {
                ...
                if (f) d = a.data[f];
                    ...
                    f = ++a.uuid;
                    var g = a.extend({}, b);
                    e.classList.contains("mui-segmented-control") &&
                        (g = a.extend(g, {
                            scrollY: !1,
                            scrollX: !0,
                            indicators: !1,
        ...
        g = a.Scroll.extend(
            a.extend({
                    ...
                    _scrollbottom: function() {
                        this.pulldown ||
                            this.loading ||
                            ((this.pulldown = !1), this._initPullupRefresh(), this.pullupLoading());
                    },
                    _start: function(a) {
                        a.touches &&
                            a.touches.length &&
                            a.touches[0].clientX > 30 &&
                            a.target &&
                            ...
                            a.preventDefault(),
                            this.loading ||
                            (this.pulldown = this.pullPocket = this.pullCaption = this.pullLoading = !1),
                            this._super(a);
                    },
                    _drag: function(a) {
                        (this.y >= 0 && this.disablePulldown && "down" === a.detail.direction) ||
                        (this._super(a), !this.pulldown &&
                            !this.loading &&
                            this.topPocket &&
                            "down" === a.detail.direction &&
                            this.y >= 0 &&
                    ...
                    pulldownLoading: function(a, b) {
                        if (
                            (void 0 === a && (a = this.options.down.height),
                    ...
                    endPulldownToRefresh: function() {
                        ...
                        a.topPocket &&
                            a.loading &&
                            this.pulldown &&
                            (a.scrollTo(0, 0, a.options.bounceTime, a.options.bounceEasing),
                                (a.loading = !1),
                    ...
                    pullupLoading: function(a, b, c) {
                        ...
                        this.scrollTo(b, this.maxScrollY, c, this.options.bounceEasing),
                            ...
                            (this._initPullupRefresh(),
                                ...
                                (this.loading = !0),
                                (a = a || this.options.up.callback) && a.call(this));
                    },
                        ...
                        b.bottomPocket &&
                            ((b.loading = !1),
                                ...
                                ((this.finished = !0),
                                    ...
                                    b.wrapper.removeEventListener("scrollbottom", b)) :
                                (b._setCaption(b.options.up.contentdown),
        ...
        if (1 === this.length) {
            ...
            return (!(!e && void 0 === b) &&
                ((b = b || {}),
                    ...
                    b.down && b.down.auto ?
                    d.pulldownLoading(b.down.autoY) :
                    b.up && b.up.auto && d.pullupLoading(),
                    d)
            );
        }
    };
    ...
    var c = "mui-slider",
        ...
        l = (a.Slider = a.Scroll.extend({
            ...
            _triggerSlide: function() {
                ...
                b.loop &&
                    (0 === b.slideNumber ?
                        b.setTranslate(b.pages[1][0].x, 0) :
                        b.slideNumber === b.itemLength - 3 &&
                        b.setTranslate(b.pages[b.itemLength - 2][0].x, 0)),
            ...
            _handleSlide: function(b) {
                ...
                if (b.target === c.wrapper) {
                    ...
                    for (
                        var e = c.scroller.querySelectorAll(j), f = [], g = 0, h = e.length; g < h; g++
                    ) {
                        var k = e[g];
                    ...
                    var l = d.slideNumber;
                    if (
                        (c.loop && (l += 1), !c.wrapper.classList.contains("mui-segmented-control"))
                    )
                        for (var g = 0, h = f.length; g < h; g++) {
                            var k = f[g];
                            k.parentNode === c.scroller &&
                                (g === l ? k.classList.add(i) : k.classList.remove(i));
                        }
                    ...
                    if (m) {
                        ...
                        if (n.length > 0)
                            ...
                            if (o) o.innerText = d.slideNumber + 1;
                                ...
                                for (
                                    var p = m.querySelectorAll(".mui-control-item"), g = 0, h = p.length; g < h; g++
                                )
            ...
            _handleIndicatorTap: function(a) {
                var b = this,
                    c = a.target;
                (c.classList.contains(f) || c.classList.contains(g)) &&
                (b[c.classList.contains(f) ? "prevItem" : "nextItem"](), a.stopPropagation());
            },
            ...
            _initTimer: function() {
                ...
                e && b.clearTimeout(e),
                    ...
                    ((e = b.setTimeout(function() {
                            c &&
                                ((c.offsetWidth || c.offsetHeight) && a.nextItem(!0), a._initTimer());
                        }, d)),
                    ...
                    this._clearRequestAnimationFrame(),
                        ...
                        (b.deltaTime < 200 &&
                            (this.x = this._getPage(
                                this.slideNumber + ("right" === c ? -1 : 1), !0
                            ).x),
                            this.resetPosition(this.options.bounceTime)) :
                        "dragend" !== a.type ||
                        b.flick ||
            ...
            _initSnap: function() {
                if (
                    ...
                    (this.slideNumber = 0),
                    (this.lastSlideNumber =
                        void 0 === this.lastSlideNumber ? 0 : this.lastSlideNumber);
                }
                this.options.startX = this.currentPage.x || 0;
            },
            _getSnapX: function(a) {
            ...
            _getPage: function(a, b) {
                return (
                    this.loop ?
                    a > this.itemLength - (b ? 2 : 3) ?
                    ((a = 1), (time = 0)) :
                    a < (b ? -1 : 0) ?
                    ((a = this.itemLength - 2), (time = 0)) :
                    (a += 1) :
                    (b ||
                        (a > this.itemLength - 1 ?
                            ((a = 0), (time = 0)) :
                            a < 0 && ((a = this.itemLength - 1), (time = 0))),
            ...
            setTranslate: function(a, b) {
                this._super(a, b),
                    this.progressBar &&
                    (this.progressBarStyle.webkitTransform = this._getTranslateStr(-a * (this.progressBarWidth / this.wrapperWidth),
                        0
                    ));
            },
            resetPosition: function(a) {
            ...
            _reInit: function() {
                for (
                    var a = this.wrapper.querySelectorAll("." + d), b = 0, c = a.length; b < c; b++
                )
                    if (a[b].parentNode === this.wrapper) {
                        this.scroller = a[b];
                        break;
            ...
            refresh: function(b) {
                b
                    ?
                    (a.extend(this.options, b), this._super(), this._initTimer()) :
                    this._super();
            },
            destroy: function() {
                this._initEvent(!0),
    ...
    (a.fn.slider = function(b) {
        ...
        return (
            this.each(function() {
                var e = this;
                if (
                    (this.classList.contains(c) || (e = this.querySelector("." + c)),
                        e && e.querySelector(j))
                ) {
                    var f = e.getAttribute("data-slider");
                    f
                        ?
                        (d = a.data[f]) && b && d.refresh(b) :
                        ((f = ++a.uuid),
                ...
                var c = "mui-visibility",
                    ...
                    j = a.Class.extend({
                            ...
                            a.plusReady(function() {
                                if ("circle" == b.options.down.style)
                                    ...
                                    a.addEventListener("close", function() {
                                            var a =
                                                b.options.webviewId && b.options.webviewId.replace(/\//g, "_");
                                        ...
                                        a.addEventListener(
                                            ...
                                            function(d) {
                                                switch (
                                                    (b.pulldown ?
                                                        b.pullPocket.classList.add(e) :
                                                        b._initPulldownRefresh(),
                                                        d.status)
                                                ) {
                        ...
                        handleEvent: function(a) {
                            ...
                            b.stopped ||
                                ((b.isScroll = !1),
                                    ("dragup" !== a.type && "plusscrollbottom" !== a.type) ||
                                    ((b.isScroll = !0),
                                        setTimeout(function() {
                                            b.isScroll = !1;
                                        }, 1e3)));
                        ...
                        a.extend({
                                        ...
                                        function() {
                                            setTimeout(function() {
                                                if ("circle" == b.options.down.style)
                                                    ...
                                                    a &&
                                                        a.setBounce({
                                                            offset: { top: b.options.down.height + "px" },
                                                        });
                                                }
                                            }, 15);
                                        }.bind(this)
                                ...
                                endPulldown: function() {
                                    ...
                                    a.parent() && "circle" !== this.options.down.style ?
                                        a
                                        .parent()
                                        .evalJS(
                                            "mui&&mui(document.querySelector('.mui-content')).pullRefresh('" +
                                            JSON.stringify({ webviewId: a.id }) +
                                ...
                                _endPulldownToRefresh: function() {
                                    ...
                                    a.topPocket &&
                                        a.options.webview &&
                                        (a.options.webview.endPullToRefresh(),
                                            (a.loading = !1),
                                            a._setCaption(a.options.down.contentdown, !0),
                                            setTimeout(function() {
                                                a.loading || a.topPocket.classList.remove(e);
                                ...
                                beginPullup: function(a) {
                                    var b = this;
                                    b.isLoading ||
                                        ((b.isLoading = !0), !1 !== b.pulldown ?
                                            b._initPullupRefresh() :
                                            this.pullPocket.classList.add(e),
                                            setTimeout(function() {
                                                b.pullLoading.classList.add(c),
                                                    b.pullLoading.classList.remove(d),
                                                    (b.pullCaption.innerHTML = ""),
                                                    (b.pullCaption.className = f + " " + h),
                                                    (b.pullCaption.innerHTML = b.options.up.contentrefresh),
                                                    (a = a || b.options.up.callback) && a.call(b);
                                            }, 300));
                                },
                                ...
                                endPullup: function(a) {
                                    var e = this;
                                    e.pullLoading &&
                                        (e.pullLoading.classList.remove(c),
                                            e.pullLoading.classList.add(d),
                                            (e.isLoading = !1),
                                            a ?
                                            ((e.finished = !0),
                                                (e.pullCaption.className = f + " " + i),
                                                (e.pullCaption.innerHTML = e.options.up.contentnomore),
                                                b.removeEventListener("plusscrollbottom", e),
                                                window.removeEventListener("dragup", e)) :
                                            ((e.pullCaption.className = f + " " + g),
                                ...
                                disablePulldownToRefresh: function() {
                                    var a = plus.webview.currentWebview();
                                    this.options.down.style && "circle" == this.options.down.style ?
                                        this.options.webview.setPullToRefresh({
                                            support: !1,
                                            style: "circle",
                                        }) :
                                        (a.setStyle({ bounce: "none" }),
                                            a.setBounce({ position: { top: "none" } }));
                                },
                                enablePulldownToRefresh: function() {
                                    var a = this,
                                ...
                                disablePullupToRefresh: function() {
                                    this._initPullupRefresh(),
                                        (this.bottomPocket.className = "mui-pull-bottom-pocket " + d),
                                        window.removeEventListener("dragup", this);
                                },
                                enablePullupToRefresh: function() {
                                    this._initPullupRefresh(),
                                        this.bottomPocket.classList.remove(d),
                                        (this.pullCaption.className = f + " " + g),
                ...
                a.fn.pullRefresh_native = function(c) {
                    ...
                    0 === this.length ?
                        ((d = b.createElement("div")),
                            (d.className = "mui-content"),
                            b.body.appendChild(d)) :
                        (d = this[0]);
                    var e = c;
                    (c = c || {}),
                    "string" == typeof c && (c = a.parseJSON(c)), !c.webviewId &&
                        (c.webviewId =
                    ...
                    return (!(!h && void 0 === e) &&
                        (h ?
                            (f = a.data[h]) :
                            ((h = ++a.uuid),
                                d.setAttribute("data-pullrefresh-plus-" + g, h),
                                b.body.classList.add("mui-plus-pullrefresh"),
                                (a.data[h] = f = new j(d, c))),
                            c.down && c.down.auto ?
                            f.beginPulldown() :
                            c.up && c.up.auto && f.beginPullup(),
                            f)
                    );
                };
            }
        ...
        m = a.Class.extend({
            ...
            refresh: function(a) {
                ...
                a
                    ...
                    (this.offCanvasLeft = a) :
                    a.classList.contains(f) && (this.offCanvasRight = a) :
                    ...
                    ((this.offCanvasRightWidth = this.offCanvasRight.offsetWidth),
                        (this.offCanvasRightSlideIn =
                            this.slideIn && this.offCanvasRight.parentNode === this.wrapper)),
                    this.offCanvasLeft &&
                    ((this.offCanvasLeftWidth = this.offCanvasLeft.offsetWidth),
                        (this.offCanvasLeftSlideIn =
                            this.slideIn && this.offCanvasLeft.parentNode === this.wrapper)),
            ...
            handleEvent: function(b) {
                switch (b.type) {
                    ...
                    case "drag":
                        var c = b.detail;
                        this.startX ?
                            (this.lastX = c.center.x) :
                            ((this.startX = c.center.x), (this.lastX = this.startX)), !this.isDragging &&
                            Math.abs(this.lastX - this.startX) > this.options.dragThresholdX &&
                            ("left" === c.direction || "right" === c.direction) &&
                            (this.slideIn ?
                                ((this.scroller = this.wrapper.querySelector(l)),
                                    this.classList.contains(j) ?
                                    this.offCanvasRight && this.offCanvasRight.classList.contains(j) ?
                                    ...
                                    ((this.offCanvas = this.offCanvasRight),
                                        (this.offCanvasWidth = this.offCanvasRightWidth)) :
                                    "right" === c.direction && this.offCanvasLeft ?
                                    ((this.offCanvas = this.offCanvasLeft),
                                        (this.offCanvasWidth = this.offCanvasLeftWidth)) :
                                    (this.scroller = null)) :
                                this.classList.contains(j) ?
                        ...
                        if (this.isDragging) {
                            ...
                            if (this.slideIn) {
                                if (
                                    ((e =
                                            f >= 0 ?
                                            (this.offCanvasRightWidth && f / this.offCanvasRightWidth) || 0 :
                                            (this.offCanvasLeftWidth && f / this.offCanvasLeftWidth) || 0),
                                        "right" === d && e <= 0 && (e >= -0.5 || c.swipe) ?
            ...
            _dispatchEvent: function() {
                this.classList.contains(j) ?
                    a.trigger(this.wrapper, "shown", this) :
                    a.trigger(this.wrapper, "hidden", this);
            },
            ...
            initEvent: function() {
                var b = this;
                b.backdrop &&
                    b.backdrop.addEventListener("tap", function(a) {
                        b.close(), a.detail.gesture.preventDefault();
                    }),
                    this.classList.contains("mui-draggable") &&
                    (this.wrapper.addEventListener(a.EVENT_START, this),
            ...
            openPercentage: function(a) {
                var b = a / 100;
                this.slideIn ?
                    (this.offCanvasLeft && a >= 0 ?
                        ((b = 0 === b ? -1 : 0),
                            this.updateTranslate(this.offCanvasLeftWidth * b),
                            this.offCanvasLeft.classList[0 !== a ? "add" : "remove"](j)) :
                        this.offCanvasRight &&
                        a <= 0 &&
                        ((b = 0 === b ? 1 : 0),
                            this.updateTranslate(this.offCanvasRightWidth * b),
                            this.offCanvasRight.classList[0 !== a ? "add" : "remove"](j)),
                        this.classList[0 !== a ? "add" : "remove"](j)) :
                    (this.offCanvasLeft && a >= 0 ?
                        (this.updateTranslate(this.offCanvasLeftWidth * b),
                            this.offCanvasLeft.classList[0 !== b ? "add" : "remove"](j)) :
                        this.offCanvasRight &&
                        a <= 0 &&
                        (this.updateTranslate(this.offCanvasRightWidth * b),
            ...
            updateTranslate: function(b) {
                if (b !== this.lastTranslateX) {
                    if (this.slideIn) {
                        ...
                        if ((!this.offCanvasLeft && b > 0) || (!this.offCanvasRight && b < 0))
                            ...
                            ((this.leftShowing = !0),
                                ...
                                (this.offCanvasLeft &&
                                    a.each(
                                        this.offCanvasLefts,
                                        function(a, b) {
                                            b === this.offCanvasLeft ?
                                                (this.offCanvasLeft.style.zIndex = 0) :
                                                (b.style.zIndex = -1);
                                        }.bind(this)
                                    ),
                                    this.offCanvasRight && (this.offCanvasRight.style.zIndex = -1))) :
                            ((this.rightShowing = !0),
                                (this.leftShowing = !1),
                                this.offCanvasRight &&
                                a.each(
            ...
            setTranslateX: a.animationFrame(function(a) {
                if (this.scroller)
                    if (this.scalable && this.offCanvas.parentNode === this.wrapper) {
                        ...
                        this.offCanvas.classList.contains(e) ?
                            ...
                            (this.offCanvas.style.webkitTransform =
                                "translate3d(0,0,0) scale(" + d + ")"),
                            (this.scroller.style.webkitTransform =
                                "translate3d(" + a + "px,0,0) scale(" + c + ")");
                    } else
                        this.slideIn ?
                        (this.offCanvas.style.webkitTransform = "translate3d(" + a + "px,0,0)") :
                        (this.scroller.style.webkitTransform = "translate3d(" + a + "px,0,0)");
            }),
            ...
            isShown: function(a) {
                ...
                if (this.slideIn)
                    ...
                    "left" === a ?
                    this.classList.contains(j) &&
                    this.wrapper.querySelector("." + e + "." + j) :
                    "right" === a ?
                    this.classList.contains(j) &&
                    this.wrapper.querySelector("." + f + "." + j) :
                    this.classList.contains(j) &&
                    (this.wrapper.querySelector("." + e + "." + j) ||
                        this.wrapper.querySelector("." + f + "." + j));
                else {
            ...
            show: function(a) {
                return (
                    this._initOffCanvasVisible(), !this.isShown(a) &&
                    (a || (a = this.wrapper.querySelector("." + f) ? "right" : "left"),
                        "right" === a ?
                        ((this.offCanvas = this.offCanvasRight),
                            (this.offCanvasWidth = this.offCanvasRightWidth)) :
                        ((this.offCanvas = this.offCanvasLeft),
            ...
            toggle: function(a) {
                ...
                a &&
                    a.classList &&
                    ((b = a.classList.contains(e) ? "left" : "right"), this.refresh(a)),
...
(function(a, b) {
    var c = "mui-action",
        d = function(a, b) {
            var d = b.className || "";
            return (
                "string" != typeof d && (d = ""), !(!d || !~d.indexOf(c)) &&
                (b.classList.contains("mui-action-back") && a.preventDefault(), b)
            );
        };
...
(function(a, b, c, d) {
    var e = "mui-popover",
        ...
        n = function(b, d) {
            if ("A" === d.tagName && d.hash) {
                if (
                    ((a.targets._popover = c.getElementById(d.hash.replace("#", ""))),
        ...
        r = (function() {
            ...
            return (
                ...
                b.addEventListener("tap", function(b) {
                    ...
                    c &&
                        (c.addEventListener("webkitTransitionEnd", q), c.classList.remove(l), s(c));
                }),
                b
            );
        })(),
    ...
    b.addEventListener("tap", function(b) {
        if (a.targets.popover) {
            ...
            d &&
                (b.detail.gesture.preventDefault(), t(a.targets._popover, a.targets.popover));
        }
    });
    var t = function(a, b, d) {
            if (!(
                    ("show" === d && a.classList.contains(l)) ||
                    ("hide" === d && !a.classList.contains(l))
                )) {
                o && o.cancel(),
                ...
                if (
                    e &&
                    (e.addEventListener("webkitTransitionEnd", q), e.classList.remove(l), a === e)
                )
                    return void s(e);
                var f = !1;
                (a.classList.contains(i) || a.classList.contains(g)) &&
                (a.classList.contains(g) ?
                    ((f = !0), r.classList.add(k)) :
                    r.classList.add(j)),
                u(a, "block"),
                    a.offsetHeight,
                    a.classList.add(l),
        ...
        u = function(a, b, c, d) {
            var e = a.style;
            void 0 !== b && (e.display = b),
                void 0 !== c && (e.top = c + "px"),
                void 0 !== d && (e.left = d + "px");
        },
        v = function(d, e, h) {
            if (d && e) {
                ...
                var r = (q && q.offsetWidth / 2) || 0,
                    ...
                    y = "top";
                l + r < p.top - b.pageYOffset ?
                    (s = p.top - l - r) :
                    l + r < j - (p.top - b.pageYOffset) - o ?
                    ((y = "bottom"), (s = p.top + o + r)) :
                    ((y = "middle"),
                    ...
                    ((t = n / 2 + p.left - k / 2),
                        ...
                        t + k > i && (t = i - k - x),
                        q &&
                        ("top" === y ? q.classList.add(m) : q.classList.remove(m),
                            (v -= t),
                            (w = k / 2 - r / 2 + v),
                            (w = Math.max(Math.min(w, k - 2 * r - 6), 6)),
                            q.setAttribute("style", "left:" + w + "px"))) :
                    "middle" === y && q.setAttribute("style", "display:none"),
                    u(d, "block", s, t);
            }
        };
    (a.createMask = function(b) {
        ...
        return (
            ...
            (e.show = function() {
                return (
                    (e._show = !0), d.setAttribute("style", "opacity:1"), c.body.appendChild(d), e
                );
            }),
            (e._remove = function() {
                return (
...
(function(a, b, c, d, e) {
    var f = "mui-control-item",
        ...
        i = "mui-tab-item",
        j = function(a, b) {
            return (!(!b.classList || (!b.classList.contains(f) && !b.classList.contains(i))) &&
                ((b.parentNode &&
                        b.parentNode.classList &&
                        b.parentNode.classList.contains(g)) ||
                    a.preventDefault(),
                    b)
            );
        };
    a.registerTarget({ name: d, index: 80, handle: j, target: !1 }),
        b.addEventListener("tap", function(b) {
            var e = a.targets.tab;
            if (e) {
                for (
                    var g, j, k, l = "mui-active", m = "." + l, n = e.parentNode; n && n !== c; n = n.parentNode
                ) {
                ...
                if (
                    (e && e.classList.add(l),
                        e.hash && (k = c.getElementById(e.hash.replace("#", ""))))
                ) {
                    if (!k.classList.contains(h))
                        return void e.classList[o ? "remove" : "add"](l);
                    if (!o) {
                        var p = k.parentNode;
                        ...
                        k.classList.add(l);
                        for (var s = [], t = p.querySelectorAll("." + h), q = 0; q < t.length; q++)
                            t[q].parentNode === p && s.push(t[q]);
...
(function(a, b, c) {
    ...
    (k.prototype.start = function(a) {
        (this.handle.style.webkitTransitionDuration = this.element.style.webkitTransitionDuration =
            ".2s"),
    ...
    (k.prototype.end = function(b) {
        this.classList.remove(g),
            ...
            ((this.isDragging = !1),
                b.stopPropagation(),
                a.trigger(this.element, "toggle", { isActive: this.classList.contains(f) })) :
            this.toggle();
    }),
    (k.prototype.toggle = function(b) {
        var c = this.classList;
        (this.handle.style.webkitTransitionDuration = this.element.style.webkitTransitionDuration = !1 === b ? "0s" : ".2s"),
        c.contains(f) ?
            (c.remove(f), (this.handle.style.webkitTransform = "translate(0,0)")) :
            (c.add(f),
    ...
    (k.prototype.setTranslateX = a.animationFrame(function(a) {
        if (this.isDragging) {
            var b = !1;
            ((this.initialState && -a > this.handleX / 2) ||
                (!this.initialState && a > this.handleX / 2)) &&
            (b = !0),
            this.lastChanged !== b &&
                (b ?
                    ((this.handle.style.webkitTransform =
                            "translate(" + (this.initialState ? 0 : this.handleX) + "px,0)"),
                        this.classList[this.initialState ? "remove" : "add"](f)) :
                    ((this.handle.style.webkitTransform =
                            "translate(" + (this.initialState ? this.handleX : 0) + "px,0)"),
    ...
    var e,
        ...
        C = function(a) {
            a
                ...
                f.classList.add(g) :
                e && e.classList.add(g) :
                (B && B.cancel(), f ? f.classList.remove(g) : e && e.classList.remove(g));
        },
        D = function() {
            if (translateX !== lastTranslateX) {
                if (buttonsRight && buttonsRight.length > 0) {
                    ...
                    translateX < -sliderActionRightWidth &&
                        (translateX = -sliderActionRightWidth -
                            Math.pow(-translateX - sliderActionRightWidth, y));
                    for (var a = 0, b = buttonsRight.length; a < b; a++) {
                        var c = buttonsRight[a];
                        void 0 === c._buttonOffset && (c._buttonOffset = c.offsetLeft),
                ...
                if (buttonsLeft && buttonsLeft.length > 0) {
                    ...
                    translateX > sliderActionLeftWidth &&
                        (translateX =
                            ...
                            Math.pow(translateX - sliderActionLeftWidth, y));
                    for (var a = 0, b = buttonsLeft.length; a < b; a++) {
                        var d = buttonsLeft[a];
                        void 0 === d._buttonOffset &&
    ...
    b.addEventListener(a.EVENT_START, function(b) {
            ...
            for (var g = b.target, h = !1; g && g !== c; g = g.parentNode)
                if (g.classList) {
                    var p = g.classList;
                    if (
                        ((("INPUT" === g.tagName && "radio" !== g.type && "checkbox" !== g.type) ||
                                "BUTTON" === g.tagName ||
                                p.contains(n) ||
                                p.contains(o) ||
                                p.contains(m)) &&
        ...
        drag: function(a) {
            if (e) {
                z ||
                    ((A = sliderActionLeft = sliderActionRight = buttonsLeft = buttonsRight = sliderDirection = sliderRequestAnimationFrame = !1),
                        (A = e.querySelector(t)) &&
                        ((sliderActionLeft = e.querySelector(u)),
                ...
                if (
                    ("left" === c && (d > 150 || d < -150) ?
                        (buttonsRight || (buttonsLeft && isOpened)) && (z = !0) :
                        "right" === c &&
                        d > -30 &&
                        d < 30 &&
        ...
        dragend: function(b) {
            if (z) {
                ...
                var d = "close",
                    ...
                    sliderActionLeftWidth;
                (c.swipe || Math.abs(translateX) > f / 2) &&
                (isOpened ?
                    "left" === c.direction && "right" === openedActions ?
                    (d = "open") :
                    "right" === c.direction && "left" === openedActions && (d = "open") :
                    (d = "open")),
                e.classList.add(s);
                var g;
                if ("open" === d) {
                    ...
                    if (
                        (E(A, i),
                            void 0 !== (g = "toLeft" === sliderDirection ? buttonsRight : buttonsLeft))
                    ) {
                        for (var j = null, k = 0; k < g.length; k++)(j = g[k]), E(j, i);
                        j.parentNode.classList.add(h),
                            e.classList.add(h),
                            isOpened ||
                            a.trigger(e, "toLeft" === sliderDirection ? "slideleft" : "slideright");
                    }
                } else
                    E(A, 0),
                ...
                if (buttonsRight && buttonsRight.length > 0 && buttonsRight !== g)
                    for (var k = 0, m = buttonsRight.length; k < m; k++) {
                        ...
                        (l = o._buttonOffset),
                        void 0 === l && (o._buttonOffset = o.offsetLeft),
                            E(o, -l);
                    }
            }
        },
            ...
            if (!d.contains(h)) {
                ...
                if (e) {
                    ...
                    for (
                        ...
                        "right" === c ?
                        E(f, -f.offsetLeft) :
                        E(f, i - f.offsetWidth - f.offsetLeft);
                    d.add(s);
        ...
        if ("radio" !== c && "checkbox" !== c) {
            ...
            if (d.contains("mui-radio")) {
                ...
                f &&
                    (f.disabled ||
                        f.readOnly ||
                        ((f.checked = !f.checked), a.trigger(f, "change")));
    ...
    b.addEventListener("tap", function(b) {
        if (e) {
            ...
            if (f && f.classList.contains(j)) {
                ...
                return (
                    i && i.classList.remove(h), d.add(h), void a.trigger(e, "selected", { el: e })
                );
            }
            if (
                d.contains("mui-collapse") &&
                !e.parentNode.classList.contains("mui-unfold")
            ) {
                if (
                    (H.test(b.target.tagName) || b.detail.gesture.preventDefault(), !d.contains(g))
                ) {
...
(function(a, b) {
    ...
    a.toast = function(b, d) {
        ...
        if (
            ((d = a.extend({ duration: "short" }, d || {})), !a.os.plus || "div" === d.type)
        ) {
            "number" == typeof d.duration ?
                (duration = d.duration > 0 ? d.duration : e.short) :
                (duration = e[d.duration]),
                duration || (duration = e.short);
            var f = document.createElement("div");
            return (
                f.classList.add("mui-toast-container"),
    ...
    var d = "mui-popup",
        ...
        u = function(b, e) {
            ...
            var j = a.qsa("." + m, h),
                ...
                n = {
                    ...
                    close: function(a, b) {
                        if (h) {
                            if (!1 === (e && e({ index: a || 0, value: (l && l.value) || "" })))
                                return;
                            !1 !== b ? (h.classList.remove(f), h.classList.add(g)) : i(),
                                p.pop(),
        ...
        v = function(b, c, d, e, f) {
            if (void 0 !== b)
                return (
                    "function" == typeof c ?
                    ((e = c), (f = d), (c = null), (d = null)) :
                    "function" == typeof d && ((f = e), (e = d), (d = null)),
                    a.os.plus && "div" !== f ?
                    plus.nativeUI.alert(b, e, c || "提示", d || "确定") :
                    u(s(b, c || "提示") + t([d || "确定"]), e)
                );
        },
        w = function(b, c, d, e, f) {
            if (void 0 !== b)
                return (
                    ...
                    "function" == typeof d && ((f = e), (e = d), (d = null)),
                    a.os.plus && "div" !== f ?
                    plus.nativeUI.confirm(b, e, c, d || ["取消", "确认"]) :
                    u(s(b, c || "提示") + t(d || ["取消", "确认"]), e)
                );
        },
        x = function(b, c, d, e, f, g) {
            if (void 0 !== b)
                return (
                    "function" == typeof c ?
                    ((f = c), (g = d), (c = null), (d = null), (e = null)) :
                    "function" == typeof d ?
                    ((f = d), (g = e), (d = null), (e = null)) :
                    "function" == typeof e && ((g = f), (f = e), (e = null)),
                    a.os.plus && "div" !== g ?
                    plus.nativeUI.prompt(b, f, d || "提示", c, e || ["取消", "确认"]) :
                    u(s(b, d || "提示", r(c)) + t(e || ["取消", "确认"]), f)
                );
        },
        y = function() {
...
(function(a, b) {
    var c = "mui-progressbar",
        ...
        i = function(h, i, j) {
            if (
                ("number" == typeof h && ((j = i), (i = h), (h = "body")),
                    (h = a(h || "body")),
                    0 !== h.length)
            ) {
                h = h[0];
                    ...
                    l
                        ...
                        ((l = b.createElement("span")),
                            (l.className =
                                ...
                                (void 0 !== i ? "" : " " + f) +
                                (j ? " " + c + "-" + j : "")),
                            void 0 !== i && (l.innerHTML = "<span></span>"),
                            h.appendChild(l));
                }
                return i && k(h, i), l;
            }
        ...
        k = function(a, b, c) {
            ...
            if (d && !d.classList.contains(f)) {
                ...
                if (e) {
                    ...
                    (g.webkitTransitionDuration = void 0 !== c ? c + "ms" : "");
                }
                return d;
            }
        };
...
(function(a, b, c) {
    var d = "mui-icon",
        ...
        s = function(a, b) {
            (this.element = a),
            (this.options = b || { actions: "clear" }), ~this.options.actions.indexOf("slider") ?
                ((this.sliderActionClass = j + " " + k), (this.sliderActionSelector = q)) :
                (~this.options.actions.indexOf("clear") &&
                    ((this.clearActionClass = d + " " + e + " " + k),
                        (this.clearActionSelector = m)), ~this.options.actions.indexOf("speech") &&
                    ((this.speechActionClass = d + " " + f), (this.speechActionSelector = n)), ~this.options.actions.indexOf("search") &&
                    ((this.searchActionClass = i), (this.searchActionSelector = p)), ~this.options.actions.indexOf("password") &&
                    ((this.passwordActionClass = d + " " + g),
                        (this.passwordActionSelector = o))),
                this.init();
        };
    ...
    (s.prototype.initAction = function() {
        ...
        c &&
            (b.sliderActionClass ?
                (b.sliderAction = b.createAction(
                    c,
                    b.sliderActionClass,
                    b.sliderActionSelector
                )) :
                (b.searchActionClass &&
                    ((b.searchAction = b.createAction(
                            c,
                            b.searchActionClass,
                            b.searchActionSelector
                        )),
                        b.searchAction.addEventListener("tap", function(c) {
                            a.focus(b.element), c.stopPropagation();
                        })),
                    b.speechActionClass &&
                    ((b.speechAction = b.createAction(
                            c,
                            b.speechActionClass,
                            b.speechActionSelector
                        )),
                    ...
                    b.clearActionClass &&
                    ((b.clearAction = b.createAction(
                            c,
                            b.clearActionClass,
                            b.clearActionSelector
                        )),
                        b.clearAction.addEventListener("tap", function(a) {
                            b.clearActionClick(a);
                        })),
                    b.passwordActionClass &&
                    ((b.passwordAction = b.createAction(
                            c,
                            b.passwordActionClass,
                            b.passwordActionSelector
                        )),
    ...
    (s.prototype.speechActionClick = function(d) {
        if (b.plus) {
            ...
            c.body.classList.add(l),
                plus.speech.startRecognize({ engine: "iFly" },
                    function(b) {
                        (e.element.value += b),
                        a.focus(e.element),
                            plus.speech.stopRecognize(),
                            a.trigger(e.element, "recognized", { value: e.element.value }),
                            f !== e.element.value &&
                            (a.trigger(e.element, "change"), a.trigger(e.element, "input"));
                    },
                    function(a) {
            ...
            this.each(function() {
                ...
                if ("range" === this.type && e.classList.contains("mui-input-range"))
                    ...
                    f.contains("mui-input-clear") && d.push("clear"),
                        (a.os.android && a.os.stream) ||
                        !f.contains("mui-input-speech") ||
                        d.push("speech"),
                        f.contains("mui-input-password") && d.push("password"),
                        "search" === this.type &&
                        e.classList.contains("mui-search") &&
                        d.push("search");
                }
                var g = this.getAttribute("data-input-" + d[0]);
                if (g) b = a.data[g];
                else {
                    (g = ++a.uuid), (b = a.data[g] = new s(this, { actions: d.join(",") }));
...
(function(a, b) {
    var c = "mui-active",
        ...
        f = function(c, d) {
            if (
                ((this.element = c),
                    (this.options = a.extend({ top: 0, offset: 150, duration: 16, scrollby: b },
                        d || {}
                    )),
            ...
            this.scrollByElem === b ?
                ...
                ~this.scrollByElem.className.indexOf("mui-scroll-wrapper") ||
                (this.isNativeScroll = !0),
    ...
    (f.prototype.initEvent = function() {
        this.scrollByElem.addEventListener("scroll", this._bufferFn),
            this.isNativeScroll &&
            this.scrollByElem.addEventListener(a.EVENT_MOVE, this._bufferFn);
    }),
    (f.prototype.handleScroll = function(d) {
        ...
        (this._style.backgroundColor =
            "rgba(" + this._R + "," + this._G + "," + this._B + "," + f + ")"),
        f > this._A ? this.element.classList.add(c) : this.element.classList.remove(c),
            this.lastOpacity !== f &&
            (a.trigger(this.element, "alpha", { alpha: f }), (this.lastOpacity = f));
    }),
        ...
        return (
            this.each(function() {
                ...
                if (!d) {
                    ...
                    null !== e && void 0 === a.top && (a.top = e),
                        null !== g && void 0 === a.offset && (a.offset = g),
                        null !== h && void 0 === a.duration && (a.duration = h),
                        null !== i &&
                        void 0 === a.scrollby &&
                        (a.scrollby = document.querySelector(i) || b),
    ...
    var b = "ontouchstart" in document,
        ...
        h = (a.Numbox = a.Class.extend({
            init: function(b, c) {
                ...
                (d.options = c),
                (d.input = a.qsa(g, d.holder)[0]),
                (d.plus = a.qsa(e, d.holder)[0]),
                (d.minus = a.qsa(f, d.holder)[0]),
                d.checkValue(),
                    d.initEvent();
            },
            initEvent: function() {
            ...
            checkValue: function() {
                ...
                if (null == b || "" == b || isNaN(b))
                    ...
                    var b = parseInt(b);
                    null != a.options.max && !isNaN(a.options.max) && b >= parseInt(a.options.max) ?
                        ((b = a.options.max), (a.plus.disabled = !0)) :
                        (a.plus.disabled = !1),
                        null != a.options.min &&
                        !isNaN(a.options.min) &&
                        b <= parseInt(a.options.min) ?
                        ((b = a.options.min), (a.minus.disabled = !0)) :
                        (a.minus.disabled = !1),
                        (a.input.value = b);
                }
            },
        ...
        h = function(b, c) {
            ...
            this.options.loadingText || (this.options.loadingText = g.loadingText),
                ...
                ((this.options.loadingIcon = "mui-spinner"),
                    "rgb(255, 255, 255)" === a.getStyles(this.element, "color") &&
        ...
        if (((this.state = a), a === e))
            ...
            this.options.loadingIcon &&
                ...
                ("right" === this.options.loadingIconPosition ?
                    (b += '&nbsp;<span class="' + this.options.loadingIcon + '"></span>') :
                    (b = '<span class="' + this.options.loadingIcon + '"></span>&nbsp;' + b)),
                this.setHtml(b);
        }
    }),
