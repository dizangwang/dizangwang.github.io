...
(function($, window, document, undefined) {
    ...
    Picker.prototype.init = function() {
        ...
        console.log(mui.os, userAgent)
        if (isIos) {
            var ua16 = navigator.userAgent.toLowerCase();
            var version16 = ua16.match(/cpu iphone os (.*?) like mac os/)[1]
            version16 = version16.replace(/_/g, ".")
            if (version16 >= "16.2") {
                return
            }
